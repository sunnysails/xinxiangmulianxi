...
<head>
    ...
    <link rel="stylesheet"
          href="/static/plugins/datatables1.10.13/extensions/FixedHeader/css/fixedHeader.bootstrap.min.css">
</head>
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="/business/rent/new" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="box-body">
    ...
    $(function () {
        var table = $(".table").DataTable({
            ...
            "columns": [
                {"data": "id", "name": "id"},
                {
                    "data": function (row) {
                        if (row.serialNumber) {
                            return "<a href='/business/rent/" + row.serialNumber + "'>" + row.serialNumber + "</a>";
                        } else {
                            return "";
                        }
                    }
                ...
                },
                {
                    "data": function (row) {
                        if (row.state == 0) {
                            ...
                            return "<p class='btn btn-xs btn-default'> <i class='fa fa-check'></i> 已完成</p>";
                        }
                    }
                }
            ],
        ...
        $(document).delegate(".checkBtn", "click", function () {
            ...
            layer.confirm("确定要将合同修改为已完成吗", function (index) {
                $.post("/business/rent/state/change", {"id": id}).done(function (resp) {
